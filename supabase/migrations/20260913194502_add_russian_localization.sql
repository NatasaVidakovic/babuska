...
-- Product names are mostly international brands already written in Cyrillic.
-- Copy them as a complete Russian baseline; the admin and canonical synchronizer
-- can replace any row with a more specific translation without requiring it.
